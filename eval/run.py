"""Run the rag-graph-2024 retrieval evaluation against the live database.
...
def main(k: int = None) -> dict:
    ...
    print(f"rag-graph-2024 retrieval evaluation (k={k}, {results['questions']} questions)")
    print(
