"""Run the RagFlowKAG retrieval evaluation against the live database.
...
def main(k: int = None) -> dict:
    ...
    print(f"RagFlowKAG retrieval evaluation (k={k}, {results['questions']} questions)")
    print(
