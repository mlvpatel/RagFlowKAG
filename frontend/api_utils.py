"""Client for the rag-graph-2024 API, used by the Streamlit frontend.

All calls go through the v1 router. The chat call posts a question and returns
the answer together with the knowledge graph trace, so the UI can show the
linked entities, the graph facts used, and each retrieval step.
"""
