...
Three sample documents so anyone can run rag-graph-2024 and judge its performance without supplying their own files. Two are small hand written business documents, and one is a real public SEC filing, so you can see it work on both clean text and a dense real world document.
